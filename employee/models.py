...
class EmployeeEducation(models.Model):
    user = models.ForeignKey(User,on_delete=models.CASCADE)
    coursepg = models.CharField(max_length=50, null = True)
    ...
    coursegra = models.CharField(max_length=50, null = True)
    ...
    coursessc = models.CharField(max_length=50, null = True)
    ...
    coursehsc = models.CharField(max_length=50, null = True)
...
class EmployeeExperience(models.Model):
    ...
    company1duration = models.CharField(max_length=105, null=True)
    ...
    company2duration = models.CharField(max_length=105, null=True)
    ...
    company3duration = models.CharField(max_length=105, null=True)
    def __str__(self):
        return self.user.username        
